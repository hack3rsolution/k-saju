...
with_node \
  ...
  --target "/Users/brucelee/Projects/k-saju/ios/Pods/Target Support Files/Pods-ksaju/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "expo-apple-authentication" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-device" "expo-eas-client" "expo-file-system" "expo-font" "expo-image-manipulator" "expo-image-picker" "expo-keep-awake" "expo-localization" "expo-print" "expo-router" "expo-sharing" "expo-system-ui" "expo-updates" "expo-web-browser"
